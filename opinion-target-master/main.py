...
if __name__ == '__main__':
    ...
    s = {'lr':0.01,
         ...
         'nepochs':5} #valore modificato per progettoML (originale=30)
    ...
    for e in xrange(s['nepochs']):
        ...
        if s['decay'] and abs(s['be']-s['ce']) >= 0:
            s['clr'] *= 0.5

        if s['clr'] < 0.1: #valore originale 1e-5, aumentato a 0.1 per diminuire la complessita
            break
